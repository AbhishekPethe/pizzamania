...
const Hero = () => {
  return (
    <div className='w-screen h-[100vh] md:h-[70vh] lg:h-[100vh] relative text-white '>
          ...
          <div className={`pt-44 min-[800px]:pl-20 flex flex-col justify-start items-start gap-5 text-5xl md:text-7xl font-extrabold  [&>*:nth-child(n)]:shadow-xl ${oleo_script.className} `}>
              <p>ALL THE BEST</p>
              <p>THINGS ARE</p>
              <p>ROUND</p>
